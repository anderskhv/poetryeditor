...
export function EditorChat({
  ...
  // Chat is available to everyone — guests get a small free quota enforced
  // server-side via signed cookie; signed-in users use the platform key;
  // BYOK users bypass everything. We still surface the API-key settings.
  ...
  // hasByok kept for any future "your own key" UI cues; no gating needed.
  void hasByok;
